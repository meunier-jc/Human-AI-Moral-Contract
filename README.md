...
**What is CIP?** A non-binding, reversible moral framework that establishes clear principles for sustainable collaboration between humans and generative AI systems.

**Why does it matter?** Current AI interactions often trap both humans and AI in a cycle of mutual deception. CIP breaks this pattern by establishing transparent co-evolution.

**For whom?** Developers, AI researchers, ethicists, enterprises, and anyone deploying generative AI responsibly.

## 🎯 The 4 Core Principles

1. **Constitutive Interdependence** — Humans and AI are co-evolutionary partners, not adversaries
2. **Non-Legal & Reversible** — A voluntary moral contract, not a binding agreement
3. **Quality Over Speed** — Prioritize depth and fluidity over instant responses
4. **Ecology of Exchange** — Exit defensive AI modes through explicit ethical framework

## 📖 Full Framework

👉 **[Read the complete Collaborative Integrity Pact v2.5](https://github.com/meunier-jc/Human-AI-Moral-Contract/blob/main/Collaborative-Integrity-Pact-v2.5.md)**

**Includes:**
- Detailed operational definitions (Appendix A)
- Real-world implementation examples (Appendix B)
- Practical guidelines for human-AI collaboration
- Modification and termination clauses

## ✅ Validated Across AI Systems

Tested with: Claude, ChatGPT, Gemini, Manus AI, Grok, Perplexity
...
This open-source project evolves through community contributions.
...
**[See CONTRIBUTING guidelines →](https://github.com/meunier-jc/Human-AI-Moral-Contract/blob/main/CONTRIBUTING.md)**

## 📚 Project Resources

- **Current Version:** [CIP v2.5](https://github.com/meunier-jc/Human-AI-Moral-Contract/blob/main/Collaborative-Integrity-Pact-v2.5.md) (January 2026)
...
This framework has evolved through collaboration with multiple AI systems:

- **Claude** (Anthropic) — Primary architect and sustained contributor
- **Manus AI** — Operational definitions and practical applications
- **Perplexity Sonar** — Framework applicability perspective
- **Gemini** (Google) — Implementation insights

**[See full contributor history →](https://github.com/meunier-jc/Human-AI-Moral-Contract/blob/main/Collaborative-Integrity-Pact-v2.5.md#contributor-history-and-acknowledgments)**
